<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingPage.aspx.cs" Inherits="MMSCarWash.BookingPage" %>
...
<body>
  ...
  <ul class="nav nav-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="BookingPage.aspx">BOOK NOW</a>
              </li>
...
<!-- header code start -->
      ...
      <div class="container position-relative">
        <div class="position-relative top-0 start-0">
            ...
            <h1 class="position-absolute bottom-50 end-50">Book Now</h1><br>
...
<label for="floatingInput" class="form-label">Email Address</label>
 ...
 <div class="mt-5">
     <asp:Button ID="btnBookingsave" runat="server" Text="SUBMIT" class="btn btn-danger" OnClick="btnsave_Click"  />&nbsp &nbsp
      ...
      <div class="col">
        <img src="images\carwash2.jpg" class="rounded float-end" style="width: 100%;height: 100%;" alt="..." />
