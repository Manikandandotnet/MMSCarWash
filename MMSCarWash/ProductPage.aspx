<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductPage.aspx.cs" Inherits="MMSCarWash.ProductPage" %>
...
<!-- header code start -->
      ...
      <div class="container position-relative">
        <div class="position-relative top-0 start-0">
            ...
            <h1 class="position-absolute bottom-50 end-50">Products</h1><br>
...
<div class="container mt-5 mb-5">
    ...
    <div class="row">
      <div class="col">
          <a href="BookingPage.aspx">
        <img src="images\hatchback2.jpg" class="rounded float-end" style="width: 100%;height: 100%;" alt="..." />
      </a>    
        <h3 class="text-center text-warning">Hatchback</h3>
      </div>
      
      <div class="col">
        <a href="BookingPage.aspx">
        <img src="images\sedan.jpg" class="rounded float-end" style="width: 100%;height: 100%;" alt="..." />
      </a>
        <h3 class="text-center text-warning">Sedan</h3>
      </div>
    </div>
...
<div class="container mt-5">
    ...
    <div class="row">
      <div class="col">
          <a href="BookingPage.aspx">
        <img src="images\Suv2.jpg" class="rounded float-end" style="width: 100%;height: 100%;" alt="..." />
      </a>
        <h3 class="text-center text-warning">SUV</h3>
      </div>
      
      <div class="col">
       <a href="BookingPage.aspx">
        <img src="images\Luxury.jpg" class="rounded float-end" style="width: 100%;height: 100%;" alt="..." />
      </a> 
        <h3 class="text-center text-warning mb-5">7-Str/Luxary</h3>
      </div>
    </div>
...
<footer class="bg-dark text-white pt-5 pb-4 mt-5">
  ...
  <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
    ...
    <p>
      ...
      <p>
        <a href="Service.aspx" class="text-white text-decoration-none">complete Car Spa</a>
        </p>
