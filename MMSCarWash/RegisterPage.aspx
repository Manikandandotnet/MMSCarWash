<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterPage.aspx.cs" Inherits="MMSCarWash.RegisterPage" %>
...
<!--Nav Bar End-->
        ...
        <center class="mt-5">
                <div class="card Registercard" style="width:30rem;height:48rem">
  <div class="card-header text-center mt">
   Registeration
  </div>
  <div class="card-body">
 ...
 <div class="mt-5 text-center">
     <asp:Button ID="btnRegistersave" runat="server" Text="SAVE" class="btn btn-danger text-center" OnClick="btnRegistersave_Click"  />&nbsp &nbsp
